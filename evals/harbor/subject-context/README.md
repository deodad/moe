...
The suite covers seven behaviors inspired by real prototype conversations:
...
7. Read an already-accurate brief without rewriting it when the turn adds no useful context.
